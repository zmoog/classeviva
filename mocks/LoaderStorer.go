...
func (_m *LoaderStorer) Load() (spaggiari.Identity, bool, error) {
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func() (spaggiari.Identity, bool, error)); ok {
		return rf()
	}
...
// NewLoaderStorer creates a new instance of LoaderStorer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewLoaderStorer(t interface {
	mock.TestingT
	Cleanup(func())
}) *LoaderStorer {
	mock := &LoaderStorer{}
